...
public class CityPlusGetCityPlus extends Fragment {
	...
	public CityPlusGetCityPlus newInstance(String text){
		CityPlusGetCityPlus mFragment = new CityPlusGetCityPlus();		
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_cityplusgetcityplus, container, false);
		...
		FontHelper.applyFont(mContext, rootView.findViewById(R.id.textView6), "fonts/GothamRnd-Light.otf");
		FontHelper.applyFont(mContext, rootView.findViewById(R.id.textView7), "fonts/GothamRnd-Light.otf");
		FontHelper.applyFont(mContext, rootView.findViewById(R.id.textView8), "fonts/GothamRnd-Light.otf");
		FontHelper.applyFont(mContext, rootView.findViewById(R.id.textView9), "fonts/GothamRnd-Light.otf");
