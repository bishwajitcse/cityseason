...
public class RoomSuites extends Fragment {
	...
	public RoomSuites newInstance(String text){
		RoomSuites mFragment = new RoomSuites();		
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_roomsuites, container, false);
		...
		FontHelper.applyFont(mContext, rootView.findViewById(R.id.txtHotelName), "fonts/GothamRnd-Light.otf");
		...
		btnView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Fragment mFragment = new RoomDetails(); 
