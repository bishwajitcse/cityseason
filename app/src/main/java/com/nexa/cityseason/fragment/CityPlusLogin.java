...
public class CityPlusLogin extends Fragment {
	...
	public CityPlusLogin newInstance(String text){
		CityPlusLogin mFragment = new CityPlusLogin();		
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_citypluslogin, container, false);
